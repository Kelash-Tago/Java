...
class JavaSwing extends JFrame {
    ...
    void createRadioButtons() {
        ...
        radioButton.addActionListener(new RadioButtonHandler());
        add(radioButton);
    }
    ...
    void createComboBox() {
        ...
        comboButton.addActionListener(new ComboBoxHandler());
        add(comboButton);
    }
}

// Separate event handler for Radio Buttons
class RadioButtonHandler implements ActionListener {
    @Override
    public void actionPerformed(ActionEvent e) {
        JavaSwing frame = (JavaSwing)((JButton)e.getSource()).getTopLevelAncestor();
        ...
        if (frame.button1.isSelected()) {
            ...
            JOptionPane.showMessageDialog(frame, "You selected: " + frame.button3.getText());
        } else {
            JOptionPane.showMessageDialog(frame, "Please select a gender option");
        }
    }
}

// Separate event handler for Combo Box
class ComboBoxHandler implements ActionListener {
    @Override
    public void actionPerformed(ActionEvent e) {
        JavaSwing frame = (JavaSwing)((JButton)e.getSource()).getTopLevelAncestor();
        String selectedCity = (String)frame.box1.getSelectedItem();
        frame.comboLabel.setText("You selected: " + selectedCity);
        JOptionPane.showMessageDialog(frame, "You selected city: " + selectedCity);
    }
}
...
public class ComboBox{
	...
	comboLabel.setBounds(50,130,200,30);
	frame.add(comboLabel);
	
	JButton comboButton =new JButton("Submit");
	comboButton.setBounds(50,110,80,30);
	...
	comboLabel.setText("You selected : "+str);

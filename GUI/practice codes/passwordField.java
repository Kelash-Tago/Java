...
public class passwordField {
	...
	label5.setBounds(150,135,100,30);
	frame.add(label5);

	JPasswordField psd =new JPasswordField();
	psd.setBounds(150, 165, 160, 30); // move it 30px down
	frame.add(psd);

	JLabel label6 =new JLabel(new String(psd.getText()));
	label6.setBounds(150,105,200,30);
	frame.add(label6);

	JButton btn =new JButton("PSD");
	btn.setBounds(150,195,80,20);
	frame.add(btn);
...
btn.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent e) {
        ...
        label6.setText("You entered: " + password);
    }
});
